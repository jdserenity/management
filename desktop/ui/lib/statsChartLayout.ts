/** Minimum plot height so Recharts ResponsiveContainer always has a non-zero parent. */
...
/** Outer StatsProgressChart card — plugin flat panel. */
export const statsProgressChartRootClass = () =>
  'plugin-panel-flat flex h-full min-h-[220px] flex-col overflow-visible p-3 lg:min-h-0';
